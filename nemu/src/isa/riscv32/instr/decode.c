...
def_THelper(cal) {
  ...
  def_INSTR_TAB("0000001 ????? ????? 000 ????? ????? ??", mulu_lo);
  def_INSTR_TAB("0000001 ????? ????? 011 ????? ????? ??", mulu_hi);
  def_INSTR_TAB("0000001 ????? ????? 001 ????? ????? ??", muls_hi);
  
  def_INSTR_TAB("0000001 ????? ????? 101 ????? ????? ??", divu_q);
  def_INSTR_TAB("0000001 ????? ????? 111 ????? ????? ??", divu_r);
  def_INSTR_TAB("0000001 ????? ????? 100 ????? ????? ??", divs_q);
  def_INSTR_TAB("0000001 ????? ????? 110 ????? ????? ??", divs_r);
  return EXEC_ID_inv;
}
